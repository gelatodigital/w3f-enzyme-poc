...
const WETH_TOKEN = new Token(SupportedChainId.POLYGON, WETH_ADDRESS, 18, "WETH", "Wrapped Ether");

export const USDC_TOKEN = new Token(SupportedChainId.POLYGON, USDC_ADDRESS, 6, "USDC", "USD//C");
...
export async function uniswapQuote(provider: any): Promise<number> {
